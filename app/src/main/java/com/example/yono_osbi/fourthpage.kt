...
import com.example.yono_osbi.databinding.ActivityFourthpageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.submit.setOnClickListener {
            if (binding.e1.text.toString().isEmpty() || binding.e2.text.toString().isEmpty()){
                ...
                val intentff = Intent(this,MainActivity::class.java)

                val data = FourthPagem(aadhar_no = binding.e1.text.toString() ,
                    mobile = util.getLocalData(this,"u"), email = binding.e2.text.toString())
